...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    ...
    <div class="w3-right w3-hide-small">
      ...
      <a href="http://localhost/WEB/index.php" class="w3-bar-item w3-button"><i class="fa fa-exclamation-triangle"></i> LOGOUT </a>
	</div>
...
<?php 
 ...
 if (!mysqli_select_db($con, 'demo'))
 {
  ...
  echo "<td><a href='bid.php?id=".$row['itemname']."'><button>Bid</button></a></td>";
  echo "</tr>";
  }
  echo "</table>";
?>
