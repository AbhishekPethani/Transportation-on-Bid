...
<?php 
 ...
 if (!mysqli_select_db($con, 'demo'))
 {
  ...
  echo "<td>".$row['deldays']."</td>";
  echo "<td>".$row['proposal']."</td>";
  echo "<td><button>Update</button></td>";//<a href='update.php?id=".$row['itemname']."'>
  echo "<td><a href='delete.php?id=".$row['bidamount']."'><button>Retract bid</button></a></td>";
  echo "</tr>";
 }
